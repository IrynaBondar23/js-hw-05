...
// У вас є об'єкт `storeInventory`, який представляє інвентар магазину. Кожен товар має назву, кількість та ціну.
// Вам потрібно написати функцію, яка додає новий товар до інвентарю, якщо його ще немає,
// або оновлює кількість, якщо товар вже є в інвентарі.
// Також функція повинна розраховувати загальну вартість всіх товарів в інвентарі.
